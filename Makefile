#!/usr/bin/make -f
# Odroid 5422 Yocto building system.
...
BBLAYERS ?= \
	$(CURDIR)/openembedded-core

CONFFILES = \
	$(TOPDIR)/env.source \
	$(TOPDIR)/conf/odroid.conf \
...
# TODO : FIX 아래 라인 수정 할 것
# ____________________________

all: init
	@echo
	@echo "Openembedded for the Odroid x environment has been initialized"
	...
	@echo " MACHINE=... bitbake core-image-minimal"
	@echo
